...
@section('content')
    ...
    <table class="table table-hover table-striped" align="center">
        ...
        <tr>
            ...
            <th style="width:740px; text-align:center;"><h4 style="color:black;">Catálogo de Unidades de medida    </h4></th>
    ...
    <table class="table table-sm" align="center">
        ...
        <tr>
            ...
            <th style="background-color:darkgreen;text-align:left;width: 300px;"><b style="color:white;font-size: x-small;">Unidad de medida </b></th>
        ...
        <tbody>
            @foreach($regumedida as $medida)
                <tr>
                    <td style="text-align:justify;vertical-align: middle;width: 5px;"><b style="color:black;font-size: x-small;">{{$medida->umed_id}}</b>
                    </td>
                    <td style="text-align:justify;vertical-align: middle;width: 300px;"><b style="color:black;font-size: xx-small;">{{$medida->umed_desc}}</b>
                    </td>
                    <td style="text-align:center;vertical-align: middle;"><b style="color:black;font-size: x-small;">{{$medida->umed_status}}</b>
                    </td>
                    <td style="text-align:center; vertical-align: middle;"><b style="color:black;font-size: x-small;">{{date("d/m/Y", strtotime($medida->umed_fecreg))}}</b>
                    </td>
                </tr>
            @endforeach
        </tbody>
