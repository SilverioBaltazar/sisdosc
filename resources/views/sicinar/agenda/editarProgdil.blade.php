                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-xs-2 form-group">
                                    <label >Oficio No.</label>
                                    <input type="text" class="form-control" name="visita_oficio" id="visita_oficio" placeholder="Oficio No." value="{{Trim($regprogdil->visita_oficio)}}" required>
                                </div>                                                            
                                <div class="col-xs-4 form-group">
                                    ...
                                    <select class="form-control m-bot15" name="periodo_id" id="periodo_id" required>
                                        ...
                                        @foreach($regperiodos as $periodo)
                                            ...
                                            @else                                        
                                               <option value="{{$periodo->periodo_id}}">{{$periodo->periodo_id}} 
                                               </option>
                                            @endif
                                        @endforeach
                                    </select>                                    
                                ...
                                <div class="col-xs-2 form-group" style="color:green;font-size:12px; text-align:right; vertical-align: middle;">
                                    <label ><b>Folio sistema<br> {{Trim($regprogdil->visita_folio)}}</label></b>
                                </div>                                                                                                        
                           </div>                            
                                ...
                                <div class="col-xs-4 form-group">
                                    ...
                                    <select class="form-control m-bot15" name="municipio_id" id="municipio_id" required>
                                        ...
                                        @foreach($regmunicipio as $municipio)
                                            @if($municipio->entidadfederativaid == $regprogdil->entidad_id && 
                                                $municipio->municipioid == $regprogdil->municipio_id)
                            ...
                            <div class="row">     
                                <div class="col-xs-4 form-group">
                                    <input type="hidden" name="visita_tipo1" id="visita_tipo1" value="4">                                   
                                    <label >DPSE </label>
