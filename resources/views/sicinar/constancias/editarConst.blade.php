            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-success"> 
                        ...
                        {!! Form::open(['route' => ['actualizarConst',$regconstancia->osc_folio], 'method' => 'PUT', 'id' => 'actualizarConst', 'enctype' => 'multipart/form-data']) !!}
                        <div class="box-body">
                            <div class="row">                            
                            ...
                            @if(!empty($regconstancia->osc_d1)||(!is_null($regconstancia->osc_d1)))
                                <div class="row">               
                                    <div class="col-xs-6 form-group">                            
                                        <label >Archivo digital de Solicitud de Constancia de Renovación de Cumplimiento de Objeto Social en formato PDF </label><br>
                                        <a href="/images/{{$regconstancia->osc_d1}}" class="btn btn-danger" title="Solicitud de Solicitud de constancia de renovación de cumplimiento de objeto social"><i class="fa fa-file-pdf-o"></i><small>PDF</small>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 offset-md-5">
                                    ...
                                    <a href="{{route('verConst')}}" role="button" id="cancelar" class="btn btn-danger">Cancelar
                                    </a>
                                </div>
                            </div>
                        </div>
...
@section('request')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\constanciaRequest','#actualizarConst') !!}
@endsection
