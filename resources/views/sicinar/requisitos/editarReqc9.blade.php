                            ...
                            @if (!empty($regcontable->osc_d9)||!is_null($regcontable->osc_d9))   
                                <div class="row">                            
                                    <div class="col-xs-6 form-group">
                                        ...
                                        <label ><a href="/images/{{$regcontable->osc_d9}}" class="btn btn-danger" title="Archivo digital de Declaración Anual en formato PDF"><i class="fa fa-file-pdf-o"></i>PDF
...
@section('request')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\reqcontables9Request','#actualizarRec9') !!}
@endsection
