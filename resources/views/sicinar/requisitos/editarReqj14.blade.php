            ...
            <div class="row">
                <div class="col-md-14">
                    <div class="box box-success">
                        ...
                        {!! Form::open(['route' => ['actualizarJur14',$regjuridico->osc_id], 'method' => 'PUT', 'id' => 'actualizarJur14', 'enctype' => 'multipart/form-data']) !!}
                        <div class="box-body">
                            <div class="row">
                            ...
                            @if (!empty($regjuridico->osc_d14)||!is_null($regjuridico->osc_d14))   
                                <div class="row">
                                    <div class="col-xs-6 form-group">
                                        <label >Archivo digital de Currículum en formato PDF</label><br>
                                        <label ><a href="/images/{{$regjuridico->osc_d14}}" class="btn btn-danger" title="Archivo digital de Currículum en formato PDF"><i class="fa fa-file-pdf-o"></i>PDF
                                ...
                                <div class="row">
                                    <div class="col-xs-6 form-group">
                                        <label >Actualizar archivo digital de Currículum en formato PDF</label>
                                        <input type="file" class="text-md-center" style="color:red" name="osc_d14" id="osc_d14" placeholder="Subir archivo digital de Currículum en formato PDF" >
                                    </div>      
                                </div>
                            @else     <!-- se captura archivo 1 -->
                                <div class="row">
                                    <div class="col-xs-6 form-group">
                                        <label >Archivo digital de Currículum en formato PDF</label>
                                        <input type="file" class="text-md-center" style="color:red" name="osc_d14" id="osc_d14" placeholder="Subir archivo digital de Currículum en formato PDF" >
                                        <input type="hidden" name="doc_id14" id="doc_id14" value="17">
                                    </div>   
                                </div>
...
@section('request')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\reqjuridico14Request','#actualizarJur14') !!}
@endsection
