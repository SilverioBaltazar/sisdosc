            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-success">
                        ...
                        {!! Form::open(['route' => ['actualizarReqc10',$regcontable->osc_folio], 'method' => 'PUT', 'id' => 'actualizarReqc10', 'enctype' => 'multipart/form-data']) !!}
                        <div class="box-body">
                            <div class="row">
                            ...
                            @if (!empty($regcontable->osc_d10)||!is_null($regcontable->osc_d10))   
                                <div class="row">
                                    <div class="col-xs-6 form-group">
                                        ...
                                        <label ><a href="/images/{{$regcontable->osc_d10}}" class="btn btn-danger" title="Archivo digital de Comprobación Deducibles de Impuestos en formato PDF"><i class="fa fa-file-pdf-o"></i>PDF
...
@section('request')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\reqcontables10Request','#actualizarRec10') !!}
@endsection
