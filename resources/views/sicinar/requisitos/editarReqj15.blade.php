                            ...
                            @if (!empty($regjuridico->osc_d15)||!is_null($regjuridico->osc_d15))   
                                <div class="row">
                                    <div class="col-xs-6 form-group">
                                        ...
                                        <label ><a href="/images/{{$regjuridico->osc_d15}}" class="btn btn-danger" title="Archivo digital última Protocolización en formato PDF"><i class="fa fa-file-pdf-o"></i>PDF
                                ...
                                <div class="row">
                                    <div class="col-xs-6 form-group">
                                        <label >Actualizar archivo digital de Última Protocolización en formato PDF</label>
                                        <input type="file" class="text-md-center" style="color:red" name="osc_d15" id="osc_d15" placeholder="Subir archivo de digital de Última Protocolización en formato PDF" >
                                    </div>      
                                </div>
                            @else     <!-- se captura archivo 1 -->
                                <div class="row">                            
                                    <div class="col-xs-6 form-group">
                                        ...
                                        <input type="file" class="text-md-center" style="color:red" name="osc_d15" id="osc_d15" placeholder="Subir archivo digital de Última protocolización en formato PDF" >
                                        <input type="hidden" name="doc_id15" id="doc_id15" value="19">
                                    </div>                                                
                                </div>
                            @endif  
...
@section('request')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\reqjuridico15Request','#actualizarJur15') !!} 
@endsection
