            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-success">
                        ...
                        {!! Form::open(['route' => ['actualizarReqop2',$regoperativo->osc_folio], 'method' => 'PUT', 'id' => 'actualizarReqop2', 'enctype' => 'multipart/form-data']) !!}
                        <div class="box-body">
                            <div class="row">
                            ...
                            @if (!empty($regoperativo->osc_d2)||!is_null($regoperativo->osc_d2))   
                                <div class="row">                            
                                    <div class="col-xs-6 form-group">
                                        ...
                                        <a href="/images/{{$regoperativo->osc_d2}}" class="btn btn-danger" title="Programa de trabajo en formato PDF"><i class="fa fa-file-pdf-o"></i>PDF
                                        </a>&nbsp;&nbsp;&nbsp;{{$regoperativo->osc_d2}}
                                        <input type="hidden" name="doc_id2" id="doc_id2" value="16">
                                    </div>   
                                    <div class="col-xs-6 form-group">                                        
                                        <label>
                                ...
                                <div class="row">                                                                     
                                    <div class="col-xs-6 form-group">
                                        <label >Actualizar archivo digital de Programa de Trabajo en formato PDF </label>
...
@section('request')
    ...
    <script type="text/javascript" src="{{ asset('vendor/jsvalidation/js/jsvalidation.js')}}"></script>
        {!! JsValidator::formRequest('App\Http\Requests\reqoperativos2Request','#actualizarReqop2') !!}
@endsection
