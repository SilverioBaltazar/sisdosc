            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-success">
                        ...
                        {!! Form::open(['route' => ['actualizarReqop3',$regoperativo->osc_folio], 'method' => 'PUT', 'id' => 'actualizarReqop3', 'enctype' => 'multipart/form-data']) !!}
                        <div class="box-body">
                            <div class="row">
                            ...
                            @if (!empty($regoperativo->osc_d3)||!is_null($regoperativo->osc_d3))   
                                <div class="row">
                                    <div class="col-xs-6 form-group">
                                        <label >Archivo digital de Informe Anual en formato PDF </label><br>
                                        <a href="/images/{{$regoperativo->osc_d3}}" class="btn btn-danger" title="Informe anual en formato PDF"><i class="fa fa-file-pdf-o"></i>PDF
                                        </a>&nbsp;&nbsp;&nbsp;{{$regoperativo->osc_d3}}
                                        <input type="hidden" name="doc_id3" id="doc_id3" value="16">
                                    </div>   
                                    <div class="col-xs-6 form-group">                                        
                                        <label>
                                ...
                                <div class="row">
                                    <div class="col-xs-4 form-group">
                                        <label >Actualizar archivo digital de Informe Anual en formato PDF </label>
...
@section('request')
    ...
    <script type="text/javascript" src="{{ asset('vendor/jsvalidation/js/jsvalidation.js')}}"></script>
        {!! JsValidator::formRequest('App\Http\Requests\reqoperativosRequest','#actualizarReqop3') !!}
@endsection
