            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-success">
                        ...
                        {!! Form::open(['route' => ['actualizarReqc8',$regcontable->osc_folio], 'method' => 'PUT', 'id' => 'actualizarReqc8', 'enctype' => 'multipart/form-data']) !!}
                        <div class="box-body">
                            <div class="row">
                            ...
                            @if (!empty($regcontable->osc_d8)||!is_null($regcontable->osc_d8))   
                                <div class="row">
                                    <div class="col-xs-6 form-group">
                                        <label >Archivo digital de Constancia de recibir donativos en formato PDF </label><br>
                                        <label ><a href="/images/{{$regcontable->osc_d8}}" class="btn btn-danger" title="Subir archivo digital de Constancia de recibir donativos en formato PDF "><i class="fa fa-file-pdf-o"></i>PDF
                                        </a>&nbsp;&nbsp;&nbsp;{{$regcontable->osc_d8}}
                                        </label>
                                        <input type="hidden" name="doc_id8" id="doc_id8" value="16">
                                    </div>   
                                    <div class="col-xs-6 form-group">                                        
                                        <label>
                                ...
                                <div class="row">
                                    <div class="col-xs-6 form-group">
                                        <label >Actualizar archivo digital de Constancia de recibir donativos en formato PDF </label>
                                        <input type="file" class="text-md-center" style="color:red" name="osc_d8" id="osc_d8" placeholder="Subir archivo digital de Constancia de recibir donativos en formato PDF " >
                                    </div>      
                                </div>
                            @else     <!-- se captura archivo 1 -->
                                <div class="row">
                                    <div class="col-xs-6 form-group">
                                        <label >Archivo digital de Constancia de recibir donativos en formato PDF</label>
                                        <input type="file" class="text-md-center" style="color:red" name="osc_d8" id="osc_d8" placeholder="Subir archivo digital de Constancia de recibir donativos en formato PDF " >
                                        <input type="hidden" name="doc_id8" id="doc_id8" value="16">
                                    </div>                                                
                                <div class="row">                                    
...
@section('request')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\reqcontables8Request','#actualizarRec8') !!}
@endsection
