                            ...
                            <div class="row">                            
                                ...
                                <div class="col-xs-6 form-group">
                                    ...
                                    @foreach($regdepen as $dep)
                                        @if($dep->depen_id == $user->depen_id)
                                            <option value="{{$dep->depen_id}}" selected>{{$dep->depen_id.' '.Trim($dep->depen_desc)}}</option>
                                        @else 
                                            <option value="{{$dep->depen_id}}">{{$dep->depen_id.' '.Trim($dep->depen_desc)}}</option>
                                        @endif                                    
                                    @endforeach
                                    </select>                           
                                </div>
