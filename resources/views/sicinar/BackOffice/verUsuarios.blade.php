                        ...
                        <div class="page-header" style="text-align:right;">                            
                            {{ Form::open(['route' => 'buscarUsuario', 'method' => 'GET', 'class' => 'form-inline pull-right']) }}
                                <div class="form-group">
                                    {{ Form::text('idd', null, ['class' => 'form-control', 'placeholder' => 'Id. Unidad admon.']) }}
                                </div>                                                             
                                <div class="form-group">
                        ...
                        <div class="box-body">
                            <table id="tabla1" border="1" style="border: 2px solid slategray;" class="table table-bordered table-sm">
                                <thead style="border-color:brown;color: brown;" class="justify">
                                    <tr>
                                        <th colspan="1" style="text-align:center; vertical-align: middle;border: 2px solid slategray;"><b style="color: green">Folio</b>
                                        </th>
                                        <th colspan="1" style="text-align:center; vertical-align: middle;border: 2px solid slategray;"><b style="color: green">Usuario</b>
                                        </th>
                                        <th colspan="1" style="text-align:center; vertical-align: middle;border: 2px solid slategray;"><b style="color: green">Unidad administrativa</b>
                                        </th>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:left; vertical-align:middle;">
                                            @foreach($regdepen as $depen)
                                                @if($depen->depen_id == $usuario->depen_id)
                                                    {{$depen->depen_id.' '.Trim($depen->depen_desc)}}
                                                    @break
                                                @endif
                                            @endforeach 
                                        </td>
                                        ...
                                        @else
                                            ...
                                            @else
                                                ...
                                                @else
                                                    ...
                                                    @else
                                                        <td style="text-align:center; vertical-align: middle;"><a class="btn btn-info" title="público"><i class="fa fa-male"></i></a></td>
                                                    @endif
                                                @endif
                                            @endif
                                        @endif
