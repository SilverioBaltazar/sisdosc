            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-success">
                        ...
                        {!! Form::open(['route' => ['actualizarsoportedet1',$regprogdanual->folio, $regprogdanual->partida], 'method' => 'PUT', 'id' => 'actualizarsoportedet1', 'enctype' => 'multipart/form-data']) !!}
                        <div class="box-body">
                            ...
                            @if (!empty($regprogdanual->soporte_01)||!is_null($regprogdanual->soporte_01))   
                                <div class="row">
                                    <div class="col-xs-6 form-group">
                                        <label >Archivo digital de soporte de enero en formato PDF</label><br>
                                ...
                                <div class="row">
                                    <div class="col-xs-6 form-group">
                                        <label >Actualizar archivo digital de soporte de enero en formato PDF</label>
                            ...
                            @else     <!-- se captura archivo 1 -->
                                <div class="row">                            
                                    <div class="col-xs-6 form-group">
                                        <label >Archivo digital de soporte de enero en formato PDF</label>
...
@section('request')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\soportedet1Request','#actualizarsoportedet1') !!}
@endsection
