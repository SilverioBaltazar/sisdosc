            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-success">
                        ...
                        {!! Form::open(['route' => ['actualizarsoportedet10',$regprogdanual->folio, $regprogdanual->partida], 'method' => 'PUT', 'id' => 'actualizarsoportedet10', 'enctype' => 'multipart/form-data']) !!}
                        <div class="box-body">
                            ...
                            @if (!empty($regprogdanual->soporte_10)||!is_null($regprogdanual->soporte_10))   
                                <div class="row">
                                    <div class="col-xs-10 form-group">
                                        <label >Archivo digital de soporte de octubre en formato PDF</label><br>
                                        <label ><a href="/storage/{{$regprogdanual->soporte_10}}" class="btn btn-danger" title="Archivo digital de ficha de soporte en formato PDF"><i class="fa fa-file-pdf-o"></i>PDF
                                ...
                                <div class="row">
                                    <div class="col-xs-10 form-group">
                                        <label >Actualizar archivo de soporte de octubre en formato PDF</label>
                                        <input type="file" class="text-md-center" style="color:red" name="soporte_10" id="soporte_10" placeholder="Subir archivo de digital de ficha de soporte en formato PDF" >
                                    </div>      
                                </div>
                            @else     <!-- se captura archivo 1 -->
                                <div class="row">                            
                                    <div class="col-xs-10 form-group">
                                        <label >Archivo digital de soporte de octubre en formato PDF</label>
                                        <input type="file" class="text-md-center" style="color:red" name="soporte_10" id="soporte_10" placeholder="Subir archivo digital de ficha de soporte en formato PDF" >
                                    </div>                                                
                                </div>
                            @endif  
...
@section('request')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\soportedet10Request','#actualizarsoportedet10') !!}
@endsection
