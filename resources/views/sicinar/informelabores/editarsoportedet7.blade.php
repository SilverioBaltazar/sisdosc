            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-success">
                        ...
                        {!! Form::open(['route' => ['actualizarsoportedet7',$regprogdanual->folio, $regprogdanual->partida], 'method' => 'PUT', 'id' => 'actualizarsoportedet7', 'enctype' => 'multipart/form-data']) !!}
                        <div class="box-body">
                            ...
                            @if (!empty($regprogdanual->soporte_07)||!is_null($regprogdanual->soporte_07))   
                                <div class="row">
                                    <div class="col-xs-7 form-group">
                                        <label >Archivo digital de ficha de soporte de julio en formato PDF</label><br>
                                        <label ><a href="/storage/{{$regprogdanual->soporte_07}}" class="btn btn-danger" title="Archivo digital de ficha de soporte en formato PDF"><i class="fa fa-file-pdf-o"></i>PDF
                                ...
                                <div class="row">
                                    <div class="col-xs-7 form-group">
                                        <label >Actualizar archivo digital de soporte de julio en formato PDF</label>
                                        <input type="file" class="text-md-center" style="color:red" name="soporte_07" id="soporte_07" placeholder="Subir archivo de digital de ficha de soporte en formato PDF" >
                                    </div>      
                                </div>
                            @else     <!-- se captura archivo 1 -->
                                <div class="row">                            
                                    <div class="col-xs-7 form-group">
                                        <label >Archivo digital de soporte de julio en formato PDF</label>
                                        <input type="file" class="text-md-center" style="color:red" name="soporte_07" id="soporte_07" placeholder="Subir archivo digital de ficha de soporte en formato PDF" >
                                    </div>                                                
                                </div>
                            @endif  
...
@section('request')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\soportedet7Request','#actualizarsoportedet7') !!}
@endsection
