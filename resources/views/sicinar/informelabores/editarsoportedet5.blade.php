            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-success">
                        ...
                        {!! Form::open(['route' => ['actualizarsoportedet5',$regprogdanual->folio, $regprogdanual->partida], 'method' => 'PUT', 'id' => 'actualizarsoportedet5', 'enctype' => 'multipart/form-data']) !!}
                        <div class="box-body">
                            ...
                            @if (!empty($regprogdanual->soporte_05)||!is_null($regprogdanual->soporte_05))   
                                <div class="row">
                                    <div class="col-xs-6 form-group">
                                        <label >Archivo digital de soporte de mayo en formato PDF</label><br>
                                        <label ><a href="/storage/{{$regprogdanual->soporte_05}}" class="btn btn-danger" title="Archivo digital de ficha de soporte en formato PDF"><i class="fa fa-file-pdf-o"></i>PDF
                                ...
                                <div class="row">
                                    <div class="col-xs-6 form-group">
                                        <label >Actualizar archivo de soporte de mayo en formato PDF</label>
                                        <input type="file" class="text-md-center" style="color:red" name="soporte_05" id="soporte_05" placeholder="Subir archivo de digital de ficha de soporte en formato PDF" >
                                    </div>      
                                </div>
                            @else     <!-- se captura archivo 1 -->
                                <div class="row">                            
                                    <div class="col-xs-6 form-group">
                                        <label >Archivo digital digital de soporte de mayo en formato PDF</label>
                                        <input type="file" class="text-md-center" style="color:red" name="soporte_05" id="soporte_05" placeholder="Subir archivo digital de ficha de soporte en formato PDF" >
                                    </div>                                                
                                </div>
                            @endif  
...
@section('request')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\soportedet5Request','#actualizarsoportedet5') !!}
@endsection
