            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-success">
                        ...
                        {!! Form::open(['route' => ['actualizarsoportedet4',$regprogdanual->folio, $regprogdanual->partida], 'method' => 'PUT', 'id' => 'actualizarsoportedet4', 'enctype' => 'multipart/form-data']) !!}
                        <div class="box-body">
                            ...
                            @if (!empty($regprogdanual->soporte_04)||!is_null($regprogdanual->soporte_04))   
                                <div class="row">
                                    <div class="col-xs-6 form-group">
                                        <label >Archivo digital de soporte de abril en formato PDF</label><br>
                                        <label ><a href="/storage/{{$regprogdanual->soporte_04}}" class="btn btn-danger" title="Archivo digital de ficha de soporte en formato PDF"><i class="fa fa-file-pdf-o"></i>PDF
                                ...
                                <div class="row">
                                    <div class="col-xs-6 form-group">
                                        <label >Actualizar archivo digital de soporte de abril en formato PDF</label>
                                        <input type="file" class="text-md-center" style="color:red" name="soporte_04" id="soporte_04" placeholder="Subir archivo de digital de ficha de soporte en formato PDF" >
                                    </div>      
                                </div>
                            @else     <!-- se captura archivo 1 -->
                                <div class="row">                            
                                    <div class="col-xs-6 form-group">
                                        <label >Archivo digital de soporte de abril en formato PDF</label>
                                        <input type="file" class="text-md-center" style="color:red" name="soporte_04" id="soporte_04" placeholder="Subir archivo digital de ficha de soporte en formato PDF" >
                                    </div>                                                
                                </div>
                            @endif  
...
@section('request')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\soportedet4Request','#actualizarsoportedet4') !!}
@endsection
