...
class progdanualRequest extends FormRequest
{
    public function messages()
    {
        return [
            ...
            'actividad_desc.min'       => 'Acción o meta es de mínimo 1 caracter.',
            'actividad_desc.max'       => 'Acción o meta es de máximo 2,000 caracteres.',
            'actividad_desc.required'  => 'Acción o meta es obligatoria.',
            ...
            'umed_id.required'         => 'Unidad de medida es obligatoria.',
    ...
    public function rules()
    {
        return [
            ...
            'actividad_desc'  => 'required|min:1|max:2000',
