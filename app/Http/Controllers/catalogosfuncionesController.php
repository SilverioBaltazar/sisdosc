...
class catalogosfuncionesController extends Controller
{
    ...
    public function actionVerFuncion(){
        ...
        $regfuncion = regFuncionModel::join('PE_CAT_PROCESOS','PE_CAT_PROCESOS.PROCESO_ID','=','PE_CAT_FUNCIONES.PROCESO_ID')
                                   ->select('PE_CAT_FUNCIONES.PROCESO_ID','PE_CAT_PROCESOS.PROCESO_DESC','PE_CAT_FUNCIONES.FUNCION_ID','PE_CAT_FUNCIONES.FUNCION_DESC','PE_CAT_FUNCIONES.FUNCION_STATUS','PE_CAT_FUNCIONES.FUNCION_FECREG')
                                   ->orderBy('PE_CAT_FUNCIONES.PROCESO_ID','ASC')
                                   ->orderBy('PE_CAT_FUNCIONES.FUNCION_ID','ASC')
                                   ->paginate(30);
