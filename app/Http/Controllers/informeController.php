...
class informeController extends Controller
{
    ...
    public function actionBuscarInforme(Request $request)
    {
        ...
        if(session()->get('rango') !== '0'){    
            $regdepen     = regdepenModel::select('DEPEN_ID', 'DEPEN_DESC')
                            ...
                            ->get();                                 
            $regprogeanual= regProgeAnualModel::select('SIEVAD_EPA.*')
    ...
    public function actionEditarInformelab($id,$id2){
        ...
        return view('sicinar.informelabores.editarInformelab',compact('nombre','usuario','regdepen','reganios','regperiodos','regmeses','regdias','regprogeanual','regprogdanual','regumedida','regepproy','regepprog','regtipometa'));
    }
            ...
            case 1:    //mes enero
                $regprogdanual= regProgdAnualModel::where(['FOLIO' => $id, 'PARTIDA' => $id2])        
                            ->update([                
                                      ...
                                      'SEMAFS_01' => $semafs_01,
                                      'SEMAFA_01' => $semafa_01,
                                      'OBS_01'    => substr(trim(strtoupper($request->obs_02)),0,3999),        
            ...
            case 3:    //Mes marzo
                $regprogdanual= regProgdAnualModel::where(['FOLIO' => $id, 'PARTIDA' => $id2])        
                            ->update([                
                                      ...
                                      'SEMAFS_01' => $semafs_01,
                                      'SEMAFA_01' => $semafa_01,
                                      'OBS_03'    => substr(trim(strtoupper($request->obs_02)),0,3999),        
            ...
            case 4:    //Mes abril
                $regprogdanual= regProgdAnualModel::where(['FOLIO' => $id, 'PARTIDA' => $id2])        
                            ->update([                
                                      ...
                                      'SEMAFS_01' => $semafs_01,
                                      'SEMAFA_01' => $semafa_01,
                                      'OBS_04'    => substr(trim(strtoupper($request->obs_02)),0,3999),        
            ...
            case 5:    //Mes mayo
                $regprogdanual= regProgdAnualModel::where(['FOLIO' => $id, 'PARTIDA' => $id2])        
                            ->update([                
                                      ...
                                      'SEMAFS_01' => $semafs_01,
                                      'SEMAFA_01' => $semafa_01,
                                      'OBS_05'    => substr(trim(strtoupper($request->obs_02)),0,3999),        
            ...
            case 6:    //Mes junio
                $regprogdanual= regProgdAnualModel::where(['FOLIO' => $id, 'PARTIDA' => $id2])        
                            ->update([                
                                      ...
                                      'SEMAFS_01' => $semafs_01,
                                      'SEMAFA_01' => $semafa_01,
                                      'OBS_06'    => substr(trim(strtoupper($request->obs_02)),0,3999),        
            ...
            case 7:    //Mes julio
                $regprogdanual= regProgdAnualModel::where(['FOLIO' => $id, 'PARTIDA' => $id2])        
                            ->update([                
                                      ...
                                      'SEMAFS_02' => $semafs_02,
                                      'SEMAFA_01' => $semafa_01,
                                      'OBS_07'    => substr(trim(strtoupper($request->obs_02)),0,3999),  
            ...
            case 8:    //Mes agosto
                $regprogdanual= regProgdAnualModel::where(['FOLIO' => $id, 'PARTIDA' => $id2])        
                            ->update([                
                                      ...
                                      'SEMAFS_02' => $semafs_02,
                                      'SEMAFA_01' => $semafa_01,
                                      'OBS_08'    => substr(trim(strtoupper($request->obs_02)),0,3999),        
            ...
            case 9:    //Mes septiembre
                $regprogdanual= regProgdAnualModel::where(['FOLIO' => $id, 'PARTIDA' => $id2])        
                            ->update([                
                                      ...
                                      'SEMAFS_02' => $semafs_02,
                                      'SEMAFA_01' => $semafa_01,
                                      'OBS_09'    => substr(trim(strtoupper($request->obs_02)),0,3999),        
            ...
            case 10:    //Mes octubre
                $regprogdanual= regProgdAnualModel::where(['FOLIO' => $id, 'PARTIDA' => $id2])        
                                ->update([                
                                      ...
                                      'SEMAFS_02' => $semafs_02,
                                      'SEMAFA_01' => $semafa_01,
                                      'OBS_10'    => substr(trim(strtoupper($request->obs_02)),0,3999),        
            ...
            case 11:    //Mes noviembre
                $regprogdanual= regProgdAnualModel::where(['FOLIO' => $id, 'PARTIDA' => $id2])        
                            ->update([                
                                      ...
                                      'SEMAFS_02' => $semafs_02,
                                      'SEMAFA_01' => $semafa_01,
                                      'OBS_11'    => substr(trim(strtoupper($request->obs_02)),0,3999),        
            ...
            case 12:    //Mes diciembre
                $regprogdanual= regProgdAnualModel::where(['FOLIO' => $id, 'PARTIDA' => $id2])        
                                ->update([                
                                      ...
                                      'SEMAFS_02' => $semafs_02,
                                      'SEMAFA_01' => $semafa_01,
                                      'OBS_12'    => substr(trim(strtoupper($request->obs_02)),0,3999),  
